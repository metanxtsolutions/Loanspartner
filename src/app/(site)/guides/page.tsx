...
const description =
  "Plain-language guides on how loans are approved, improving your credit score, when a balance transfer pays, business loan documents, the DSA business and avoiding loan fraud. Reviewed by the LoansPartner credit desk.";
  ...
  return (
    <>
      ...
      <PageHero
        ...
        eyebrow="Guides"
        title="How lending actually works, written by people who did the underwriting."
        lede={siteConfig.editorialTeam.description}
      />
      <Section tone="cream">
        ...
        return (
          ...
          >
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {list.map((g, i) => (
                <GuideCard key={g.slug} guide={g} delay={(i % 3) * 70} />
              ))}
            </div>
          </Section>
        );
