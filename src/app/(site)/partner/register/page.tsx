...
const description =
  "Apply to become a LoansPartner channel partner in two minutes. Free registration, verification within one working day, training and partner code within a week.";

export const metadata: Metadata = pageMetadata({
  title,
  description,
  path: "/partner/register",
  keywords: ["DSA registration online", "loan DSA registration", "register as loan agent", "DSA apply online"],
});
      ...
      <Section tone="paper" className="!pt-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Register", path: "/partner/register" },
          ]}
          className="mb-8"
        />
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="eyebrow text-brass-600">Partner application</p>
            <h1 className="display text-ink-950 mt-3 text-4xl sm:text-5xl">Register as a channel partner</h1>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28 lg:self-start">
            ...
            <Card className="bg-ink-900 p-6 text-white">
              <p className="eyebrow text-brass-400">Questions first?</p>
