...
const title = "Loan Interest Rates in India, September 2026";
    ...
    <>
      ...
      <Section tone="paper">
        <div className="grid gap-8 lg:grid-cols-3">
          <Card className="p-6"><p className="eyebrow text-verdant-600">Benchmark</p><p className="mt-2 font-display text-3xl">Repo rate 5.25%</p><p className="mt-2 text-sm text-mute">The benchmark for repo-linked floating-rate loans as of September 2026. Such home loans price at the repo rate plus a spread of roughly 2.1% to 2.75%, fixed at sanction. Confirm the current rate on the RBI website.</p></Card>
