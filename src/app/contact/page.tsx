      ...
      <Section tone="cream">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="space-y-4">
            ...
            <Card className="p-5"><p className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-mute"><MapPin className="size-4 text-verdant-600" /> Office</p><p className="mt-2 text-sm text-ink-800">{[a.street, a.locality, a.region, a.postalCode].filter(Boolean).join(", ")}, India</p><p className="mt-2 flex items-center gap-1.5 text-xs text-mute"><Clock3 className="size-3.5" /> {siteConfig.contact.hours}</p></Card>
