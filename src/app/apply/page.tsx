...
const next = [
  ...
  { name: "We call", text: "Within one working day, with a shortlist of lenders, indicative rates and the documents to keep ready." },
    ...
    <>
      ...
      <Section tone="paper" className="!pt-10">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="eyebrow text-verdant-600">Free eligibility check</p>
            <h1 className="display mt-3 text-4xl text-ink-950 sm:text-5xl">Tell us what you need.</h1>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28 lg:self-start">
            <Card className="p-6"><p className="eyebrow text-mute">What happens next</p><div className="mt-4"><Steps steps={next} /></div></Card>
            <Card className="bg-ink-900 p-6 text-white">
              <p className="eyebrow text-verdant-400">Prefer to call?</p>
              <p className="mt-2 text-sm text-white/75"><a href={`tel:${siteConfig.contact.phone}`} className="font-bold text-white underline underline-offset-4">{siteConfig.contact.phoneDisplay}</a>, {siteConfig.contact.hours}.</p>
