  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: 64,
        background: "linear-gradient(135deg, #0B1B33 0%, #10264A 60%, #163464 100%)",
        color: "white",
    ...
    >
      <div
        style={{
          ...
          height: 520,
          borderRadius: 9999,
          background: "rgba(18,153,111,0.22)",
          filter: "blur(40px)",
        }}
      />
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <svg width="56" height="56" viewBox="0 0 48 48" fill="none">
          <rect width="48" height="48" rx="13" fill="#F7F5EF" />
          <path d="M13 31c0-8.3 6.7-15 15-15h7" stroke="#0B1B33" strokeWidth="4" strokeLinecap="round" />
        ...
        <div style={{ display: "flex", fontSize: 34, letterSpacing: -1 }}>
          Loans<span style={{ color: "#3FB48E" }}>Partner</span>
        </div>
        {eyebrow && (
          <div
            style={{
      ...
      >
        ...
        <div style={{ display: "flex", gap: 24 }}>
          <span>Zero fee to borrowers</span>
          <span>Banks, HFCs and NBFCs</span>
          <span>RBI-regulated lending only</span>
        </div>
      </div>
    </div>,
    { ...ogSize },
