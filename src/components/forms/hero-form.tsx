...
export function HeroForm({
  ...
  return (
    <form
      onSubmit={onSubmit}
      method="post"
      aria-label="Check your loan eligibility"
    ...
    >
      ...
      <p className="text-mute flex items-center justify-center gap-1.5 text-center text-[11px]">
        <Lock className="size-3" aria-hidden /> No fee, no spam, no impact on your credit score.
      </p>
    </form>
  );
}
