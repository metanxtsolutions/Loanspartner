...
export function CtaBand({
  ...
  return (
    <section className="container-x pb-16 lg:pb-24">
      <div
        className="noise rounded-panel bg-ink-900 relative overflow-hidden px-6 py-12 text-white sm:px-12 lg:px-16 lg:py-16"
        data-reveal
      >
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            ...
            {secondary ? (
              ...
              <ButtonLink href={`tel:${siteConfig.contact.phone}`} variant="outline-light" size="lg">
